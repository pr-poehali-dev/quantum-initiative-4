    ...
    <main className="relative h-screen w-full overflow-hidden bg-background">
      ...
      >
        ...
        >
          ...
          <span className="font-sans text-xl font-semibold tracking-tight text-foreground">Тамагочи</span>
        </button>

        <div className="hidden items-center gap-8 md:flex">
          {["Главная", "Возможности", "Особенности", "О проекте", "Контакты"].map((item, index) => (
            <button
              key={item}
